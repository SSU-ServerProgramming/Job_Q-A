...
extension API: TargetType {
    ...
    var path: String {
        ...
        case .getMyPostComment:
            return "/mypage/user/{user_id}/comments"
...
//        print("🚨\(request.title), \(request.category_id) \(request.content)")
    ...
    static func postComment(request: PostCommentRequest) {
    ...
    static func editBoard(board_id: Int, requestBody: EditRequest) {
    ...
    static func deleteBoard(board_id: Int, category_id: Int) {
    ...
    static func editComment(comment_id: Int, content: String){
    ...
    static func likeBoard(boardId: Int) -> Void {
